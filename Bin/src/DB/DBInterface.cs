// ************** CAUTION ****************************
// db.exe must be compiled under 6.0 branch with the 6.0 version of COMInterfaces.
// This 7.0 file and the 6.0 files should be identical.
// The resulting db.exe and ComInterfaces.dll must both be copied to DistFiles\MSSQLMigration in FW7.0
// *******************************************************
...
namespace DBProgram
{
	public class Globals
	{
		...
		static private string m_sFwCodeFolder = null;
		static private string m_sMigrationFolder = null;
		...
		static public string FwCodeFolder
		{
			get
			{
				if (m_sFwCodeFolder == null)
				{

					m_sFwCodeFolder = "c:\\SIL\\Program Files\\FieldWorks\\";  // Default location
					Microsoft.Win32.RegistryKey oKey = Microsoft.Win32.Registry.LocalMachine.OpenSubKey("Software\\SIL\\FieldWorks");
					if (oKey != null)
					{
						object oFolder = oKey.GetValue("RootCodeDir");
						if (oFolder != null)
							m_sFwCodeFolder = oFolder.ToString();
					}
				}
				return m_sFwCodeFolder;
			}
		}
		...
		static public string TemplateFolder
		{
			get
			{
				if (m_sTemplateFolder == null)
				{
					...
					m_sTemplateFolder = FwCodeFolder;
		...
		static public string MigrationFolder
		{
			get
			{
				if (m_sMigrationFolder == null)
				{

					m_sMigrationFolder = FwCodeFolder;
					if (!m_sMigrationFolder.EndsWith("\\"))
						m_sMigrationFolder += "\\";
					m_sMigrationFolder += "DataMigration\\";
				}
				return m_sMigrationFolder;
			}
		}
	...
	public class DBInterface
	{
		...
		static public bool DumpDB(string sDatabaseName)
		{
			if (!Globals.DatabaseExists(sDatabaseName))
				return false;
			string sXMLFilename = Globals.DbFolder + sDatabaseName + ".xml";
