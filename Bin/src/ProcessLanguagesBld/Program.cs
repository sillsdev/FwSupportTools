...
namespace ProcessLanguagesBld
{
	class Program
	{
		/// <summary>
		/// Entry point.
		/// Needs to be called with 3 arguments: the build configuration, the path to the FW root folder
		/// (e.g. C:\FW-WW) and the path to the FW Output folder (e.g. C:\FW-WW\Output).
		/// </summary>
		...
		static int Main(string[] args)
		{
			if (args.Length != 3)
			{
				...
				Console.WriteLine("ProcessLanguagesBld.exe <Debug|Release> <FW-path> <FW-Output-path>");
