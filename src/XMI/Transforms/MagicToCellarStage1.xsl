...
<xsl:stylesheet version="1.0"
   ...
   xmlns:UML="omg.org/UML/1.4" exclude-result-prefixes="UML">
   ...
   <xsl:template match="/">
	  <EntireModel version="{/XMI/XMI.content/UML:Model/UML:ModelElement.taggedValue/UML:TaggedValue[@name='Version']/UML:TaggedValue.dataValue}">
		 <xsl:for-each select="/XMI/XMI.content/UML:Model/UML:Namespace.ownedElement/UML:Package/UML:Namespace.ownedElement/UML:Package">
			<CellarModule
			   ...
			   <xsl:apply-templates select="UML:ModelElement.comment"/>
			   <xsl:apply-templates select="UML:ModelElement.taggedValue/UML:TaggedValue[@name='Notes']"/>
   ...
   <xsl:template match="UML:ModelElement.comment">
	  <xsl:if test="UML:Comment/@name">
		 <comment>
			<!-- Format the text of each comment -->
			<xsl:call-template name="FormatText">
			   <xsl:with-param name="text">
				  <xsl:for-each select="UML:Comment">
   ...
   <xsl:template match="UML:ModelElement.taggedValue/UML:TaggedValue[@name='Notes']">
	  <xsl:if test="UML:TaggedValue.dataValue">
		 <notes>
			<!-- Format the text of each note -->
			<xsl:call-template name="FormatText">
			   <xsl:with-param name="text">
				  <xsl:for-each select="UML:TaggedValue.dataValue">
					 <xsl:value-of select="."/>
				  </xsl:for-each>
			   </xsl:with-param>
			</xsl:call-template>
