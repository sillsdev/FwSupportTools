...
# rm-dontloc3.pl ORIGFILE.pot messages-DONTLOC.po NEWFILE.pot
...
# rm-dontloc3.pl expects 3 arguments, including the file of strings to remove.
# rm-dontloc.pl expects 2 arguments, and hardcodes the location of that file.
...
if ($#ARGV != 2) {
	print STDERR "Usage: rm-dontloc3.pl origfile.pot messages-DONTLOC.po newfile.pot\n";
	print "ARG[0] = $ARGV[0]\n";
	print "ARG[1] = $ARGV[1]\n";
	print "ARG[2] = $ARGV[2]\n";
	exit;
