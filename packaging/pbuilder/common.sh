...
init()
{
	...
	UBUNTU_DISTROS="devel trusty xenial bionic cosmic disco eoan focal groovy hirsute impish jammy kinetic lunar mantic noble"
	...
	# Debian versions
	DEBIAN_DISTROS="wheezy jessie stretch buster bullseye bookworm trixie forky"
